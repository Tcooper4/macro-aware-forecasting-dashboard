...
# --- Tabs ---
tabs = st.tabs([
    "📊 FRED", "🌍 GDP", "📈 Inflation", "📉 Unemployment", "🌫 CO₂ Emissions"
])
...
# --- Reusable WB Chart Renderer ---
def render_world_bank_chart(labels):
    try:
...
with tabs[4]:
    co2_options = [
        ...
        "CO₂ Emissions from Solid Fuel (kt)"
    ]
    selected_indicators = st.multiselect("Select CO₂ Indicators", co2_options, default=co2_options[:1])
    render_world_bank_chart(selected_indicators)
